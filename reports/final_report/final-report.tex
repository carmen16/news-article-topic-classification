...
\begin{tabular}{lrrrc}
	...
	\midrule
	Full Text			& \textbf{0.729}	& \textbf{0.815}	& 0.190		& \cellcolor[gray]{0.92} LR \\
	Lead Paragraph	& 0.682		& 0.731		& \textbf{0.248}	& \cellcolor[gray]{0.92} LR \\
	Headlines			& 0.622		& 0.647		& 0.173		& \cellcolor[gray]{0.92} LR \\
	Nouns			& 0.713		& 0.786		& 0.185		& \cellcolor[gray]{0.92} LR \\
	Lemmas			& 0.727		& 0.811		& 0.189		& \cellcolor[gray]{0.92} LR \\
	\midrule
	\multirow{2}{*}{\textbf{Best Input}} & \cellcolor[gray]{0.92} Full & \cellcolor[gray]{0.92} Full & \cellcolor[gray]{0.92} Lead & \cellcolor[gray]{0.75} \textbf{Full Text} \\
	& \cellcolor[gray]{0.92} Text & \cellcolor[gray]{0.92} Text & \cellcolor[gray]{0.92} Para & \cellcolor[gray]{0.75} \textbf{in LR} \\
	\bottomrule
\end{tabular}
}
