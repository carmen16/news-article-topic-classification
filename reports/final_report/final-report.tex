...
\begin{enumerate}
\item Full Text, Nouns, and Lemmas form a cluster at the top. In this case, Lemmas perform best of the three, so potentially the CNN values the high word count combined with a lower vocabulary size.
